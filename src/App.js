        ...
        <div className="App">
          <header className="App-header">
            ...
            <div className="TextLead">
              <h1 className="LeadTextH1">Leads Near Me</h1>
            </div>
          </header>

          <div className=" App2">
            <h1 className="Ads">Google Ads</h1>
            <p className="AdText">Previous 30 days</p>
          </div>
              ...
              <table className="LocalSEOTable1">
                ...
                {this.state.data3.map((rowdata, i) => (
                  <tbody className="table2body">
                    <tr>
                      <td className="RowStyle1">{rowdata.name}</td>
                      <td className="RowStyle1">{rowdata.position}</td>
                      <td className="RowStyle1">{rowdata.location}</td>
                    </tr>
                  </tbody>
                ))}
              </table>
