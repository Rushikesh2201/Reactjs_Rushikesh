...
export class Dashboard extends Component {
  constructor() {
    ...
    this.state = {
      ...
      adGroupData: [],
      filterDateRange: [
        startOfDay(subDays(new Date(), 31)),
  ...
  onChangeDateFilter = (e) => {
    this.setState(
      { filterDateRange: [moment(e[0]).toDate(), moment(e[1]).toDate()] },
      () => {
        this.getCampaignsData();
        this.getCallData();
      }
  ...
  getCampaignsData = () => {
    ...
    let payload = {
      from_date: moment(this.state.filterDateRange[0]).format(
        "YYYY-MM-DDT00:00:00"
      ),
      to_date: moment(this.state.filterDateRange[1]).format(
        "YYYY-MM-DDT00:00:00"
      ),
    };
      ...
      <>
        ...
        <div className={[Styles.container, "container-fluid"].join(" ")}>
          <div className={Styles.App}>
            <div
              className="col-md-12  d-flex align-items-center justify-content-end"
              style={{ padding: "13px 0px 13px 0px" }}
            >
              <CustomDateRangePicker
                filterDateRange={filterDateRange}
                onChangeDateFilter={(e) => this.onChangeDateFilter(e)}
            ...
            {/* <div className={[Styles.TableContainer, "col-md-12 col-sm-12"].join(" ")}>
              <Table />
            </div> */}
            <div
              className={[Styles.container2, "col-md-12 col-sm-12"].join(" ")}
            >
                <Tags
                  heading="Local SEO"
              ...
              <div className={Styles.outerCallData}>
                ...
                <div className="">
                  ...
                  >
                    ...
                    <p>
                      {moment(this.state.filterDateRange[0]).format(
                        "DD - MM - YYYY"
                      )}
                    </p>
                    <FontAwesomeIcon
                    ...
                    />
                    <div
                      className={Styles.LocalParaDiv}
                      style={{ marginLeft: 10 }}
                    >
                      <p className={Styles.LocalPara}>To</p>
                    </div>
                    <p>
                      {moment(this.state.filterDateRange[1]).format(
                        "DD - MM - YYYY"
                      )}
                    </p>
                  </div>
