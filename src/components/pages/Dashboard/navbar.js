  ...
  return (
    ...
    <Navbar collapseOnSelect expand ="lg " className={Styles.nav_container} >
      <Container>
        ...
        <Navbar.Brand
        href="#home" className={Styles.leadsText}>
          Leads Near Me
        
      </Navbar.Brand>
      <Navbar.Toggle aria-controls="responsive-navbar-nav"  className={Styles.responsive_navbar_nav}/>
      <Navbar.Collapse id="responsive-navbar-nav" className={Styles.collaps_nav}>

      <Nav className={Styles.dropdown_nav} pullRight>
            <Nav.Link href="#Home" className={Styles.Home_nav}> 
                Home           
            </Nav.Link>
            <FontAwesomeIcon icon={faGear} size="1x" className={Styles.Icon} />

            <NavDropdown  className={Styles.dropdown} id={Styles["basic-nav-dropdown"]}>
              <NavDropdown.Item
                onClick={profile}
